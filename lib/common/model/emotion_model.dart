...
enum EmotionCategory {
  ...
  static const EmotionCategoryList = ["웃김", "기쁨", "화남", "놀람", "슬픔"];
...
extension EmotionCategoryList on EmotionCategoryModel {
  static List<EmotionCategoryModel> categories = [
    EmotionCategoryModel(category: EmotionCategory.smile, words: [
      ...
      EmotionModel(word: "흐뭇한", definition: """형용사 마음에 흡족하여 매우 만족스럽다."""),
      EmotionModel(word: "상쾌한", definition: """형용사 느낌이 시원하고 산뜻하다."""),
      EmotionModel(
          word: "짜릿한",
          definition:
    ...
    EmotionCategoryModel(category: EmotionCategory.sad, words: [
      ...
      EmotionModel(word: "눈물겨운", definition: """형용사 눈물이 날 만큼 가엾고 애처롭다."""),
      EmotionModel(
          word: "처량한",
          definition: """1.형용사 마음이 구슬퍼질 정도로 외롭거나 쓸쓸하다.\n2.형용사 초라하고 가엾다."""),
      EmotionModel(
          word: "위축되는",
          definition:
    ...
    EmotionCategoryModel(category: EmotionCategory.angry, words: [
      EmotionModel(word: "얄미운", definition: """형용사 말이나 행동이 약빠르고 밉다."""),
      EmotionModel(word: "열받는", definition: """동사 사람이 감정의 자극을 받거나 격분하다."""),
      EmotionModel(word: "못마땅한", definition: """형용사 마음에 들지 않아 좋지 않다."""),
      EmotionModel(
          word: "불쾌한",
          definition: """1.형용사 못마땅하여 기분이 좋지 아니하다.\n2.형용사 몸이 찌뿌드드하고 좋지 않다."""),
      EmotionModel(
          word: "심술나는",
          definition:
    ...
    EmotionCategoryModel(category: EmotionCategory.surprised, words: [
      EmotionModel(
          word: "당황스러운", definition: """형용사 놀라거나 다급하여 어찌할 바를 몰라 하는 데가 있다."""),
      EmotionModel(word: "긴장되는", definition: """동사 마음을 조이고 정신을 바짝 차리게 되다."""),
      EmotionModel(
          word: "억울한",
          definition: """형용사 아무 잘못 없이 꾸중을 듣거나 벌을 받거나 하여 분하고 답답하다."""),
      EmotionModel(
          word: "걱정스러운", definition: """형용사 걱정이 되어 마음이 편하지 않은 데가 있다."""),
      EmotionModel(
          word: "놀라운",
          definition:
    ...
    EmotionCategoryModel(category: EmotionCategory.bigSmile, words: [
      EmotionModel(
          word: "재미있다", definition: """형용사 아기자기하게 즐겁고 유쾌한 기분이나 느낌이 있다."""),
      EmotionModel(
          word: "경쾌한", definition: """형용사 움직임이나 모습, 기분 따위가 가볍고 상쾌하다."""),
      EmotionModel(word: "명량한", definition: """형용사 환하게 밝다."""),
      EmotionModel(
          word: "신나는", definition: """동사 어떤 일에 흥미나 열성이 생겨 기분이 매우 좋아지다."""),
      EmotionModel(
          word: "흥분된", definition: """동사 어떤 자극을 받아 감정이 북받쳐 일어나게 되다."""),
    ]),
  ];
}
